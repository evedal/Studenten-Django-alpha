...
class Utested(models.Model):
    ...
    apningstider = models.TextField(max_length=100, default="Mandag-fredag: 00:00-00:00 Lørdag: 00:00-00:00 Søndag: 00:00-00:00")
    olpriser = models.TextField(max_length=100, default="Dahls fatøl: 75kr,Rom og cola: 91kr")
